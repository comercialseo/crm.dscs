...
/**
 * AppClientesNegociosFixture
 *
 */
class AppClientesNegociosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fx_app_cliente_negocio_sector' => ['type' => 'foreign', 'columns' => ['app_cliente_negocio_sector_id'], 'references' => ['app_clientes_negocios_sectores', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cn_comentario' => 1,
                'cn_creacion' => 1554147280,
                'cn_modificacion' => '2019-04-01 19:34:40',
