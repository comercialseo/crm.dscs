...
class SettingsConfigurationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'weight' => 1,
                'autoload' => 1,
                'created' => '2019-04-04 10:56:58',
                'modified' => '2019-04-04 10:56:58'
            ],
        ];
        parent::init();
    }
