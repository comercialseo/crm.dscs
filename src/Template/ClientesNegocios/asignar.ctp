...
/**
 * =====================================================================
 * Vista Asignar Nuevos Negocios a Clientes de la App
 * =====================================================================
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav ds-flex lst-sty-n">
        <li class="pdd-laterales-10"><?= $this->Html->link(__('<i class="fa fa-undo"></i> Volver al listado'), ['controller' => 'clientes', 'action' => 'index'], ['class' => 'btn btn-success btn-xs', 'escape' => false]) ?></li>
    </ul>
</nav>
...
<div class="x_content">
  ...
  <span class="section">Datos del nuevo Negocio Asignado a Cliente <?= $appCliente->cl_nombre.' '.$appCliente->cl_apellidos ?></span>
  ...
  <div class="item form-group">
    ...
    <?= $this->Html->link(__('Crear Nuevo Sector'), [
  ...
  <div class="form-group">
    <div class="col-md-6 col-md-offset-3">
      <?= $this->Form->hidden('app_clientes_id', ['value' => $appCliente->id]); ?>
