...
/**
 * =====================================================================
 * Vista de Edición de Proveedores de la App
 * =====================================================================
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav ds-flex lst-sty-n">
        ...
        <li class="pdd-laterales-10"><?= $this->Form->postLink(
                __('<i class="fa fa-trash-o"></i> Borrar Proveedor'),
                ['action' => 'borrar', $appProveedore->id],
          ['escape' => false, 'confirm' => __('¿Confirmas que deseas borrar a este Proveedor # {0}? ', $appProveedore->pr_nombre), 
...
<div class="x_content">
  ...
  <span class="section">Formulario de Edición de Datos de Proveedor <small><?= h($appProveedore->pr_nombre) ?></small></span>
  ...
  <div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      $this->Form->select('pr_provincia', [
                  ...
                  [
                      'value'    => $appProveedore->pr_provincia,
                      'class'    => 'form-control col-md-7 col-xs-12',
                      'label'    => false,
                      'required' => 'required'
                  ]);
