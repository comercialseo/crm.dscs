...
/**
 * =====================================================================
 * Vista de Edición de Productos de la App
 * =====================================================================
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav ds-flex lst-sty-n">
        ...
        <li class="pdd-laterales-10"><?= $this->Form->postLink(
                __('<i class="fa fa-trash-o"></i> Borrar Producto'),
                ['action' => 'borrar', $appProducto->id],
          ['escape' => false, 'confirm' => __('¿Confirmas que deseas borrar a este Producto # {0}?', $appProducto->pr_nombre), 
